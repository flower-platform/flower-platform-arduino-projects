...
protected:
	...
	virtual void httpServer_onCommandReceived(Event* event) {
		...
		if (strcmp_P(command, PSTR("")) == 0) {
			...
			castedEvent->client->print(F("content{font-size:21px;font-weight:300;line-height:1.4}<\/style><\/head><body class=\"content\"><br\/><div class=\"container-fluid\"><div class=\"row\"><div class=\"col-md-2\"><div class=\"panel panel-primary text-center\"><div class=\"panel-heading\">Light 1<\/div><div class=\"panel-body\"><div class=\"label\"> State:"));
			castedEvent->client->print(F(" <span classToggler='{\"1\":\"label-warning\",\"0\":\"label-success\"}' bindToProperty=\"output1\" textToggler='{\"1\":\"OFF\",\"0\":\"ON\"}'><\/span><\/div><div> Commands: <\/div><button class=\"btn btn-block btn-lg\" type=\"button\" onclick=\"invoke('light1Toggle')\"> Toggle <\/button><button class=\"btn btn-block btn-lg\" typ"));
			castedEvent->client->print(F("e=\"button\" onclick=\"invoke('light1On')\"> Turn On <\/button><button class=\"btn btn-block btn-lg\" type=\"button\" onclick=\"invoke('light1Off')\"> Turn Off <\/button><\/div><\/div><\/div><div class=\"col-md-2\"><div class=\"panel panel-primary text-center\"><div class=\"panel-heading\">Light 2<\/div><div class=\"panel"));
			castedEvent->client->print(F("-body\"><div class=\"label\"> State: <span classToggler='{\"1\":\"label-warning\",\"0\":\"label-success\"}' bindToProperty=\"output2\" textToggler='{\"1\":\"OFF\",\"0\":\"ON\"}'><\/span><\/div><div> Commands: <\/div><button class=\"btn btn-block btn-lg\" type=\"button\" onclick=\"invoke('light2Toggle')\"> Toggle <\/button><button"));
			castedEvent->client->print(F(" class=\"btn btn-block btn-lg\" type=\"button\" onclick=\"invoke('light2On')\"> Turn On <\/button><button class=\"btn btn-block btn-lg\" type=\"button\" onclick=\"invoke('light2Off')\"> Turn Off <\/button><\/div><\/div><\/div><\/div><div class=\"row\"><div class=\"col-md-12\"><span class=\"label label-default\"><span class"));
			castedEvent->client->print(F("=\"glyphicon glyphicon-dashboard\"><\/span> Free memory (SRAM): <span bindToProperty=\"FREE_MEM\"><\/span> bytes<\/span><\/div><\/div><\/div><\/body>"));
			return;
